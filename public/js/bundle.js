...
var socket = socket_io_client_1.default('https://amonguscss-backend.onrender.com');
socket.on('setupPlayers', function (playersToSetup) {
    Object.keys(playersToSetup).forEach(function (id) {
        var _a = playersToSetup[id], top = _a.top, left = _a.left, color = _a.color, lookingLeft = _a.lookingLeft;
        addPlayer(id, top, left, color, lookingLeft);
    });
    start();
});
socket.on('playerConnect', function (id, color) {
...
socket.on('playerUpdate', function (id, player) {
    ...
    players[id] = __assign(__assign({}, players[id]), player);
...
function removePlayer(id) {
    delete players[id];
    var playerToDelete = document.getElementById(id);
    playerToDelete === null || playerToDelete === void 0 ? void 0 : playerToDelete.remove();
}
function addPlayer(id, topPosition, leftPosition, color, lookingLeft) {
    ...
    var playerShadow = document.createElement('div');
...
function idleAnimation(id) {
    var playerToAnimate = players[id];
